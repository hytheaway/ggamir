...
def select_audio_file():
    ...
    try:
        ...
        # audio_file_path_short = func.stringops.shorten_file_name(os.path.basename(audio_file_path), 30)
        ...
        shared.globals.audio_file_basename = audio_file_basename
        return audio_file_path, audio_file_basename
